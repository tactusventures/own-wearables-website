...
var deleteProductBtn = document.querySelectorAll('.product-delete-btn');
if (deleteProductBtn) {
  deleteProductBtn.forEach(function (element) {
    element.addEventListener('click', function (e) {
      var id = element.dataset.id;
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/products/delete-product", {
        id: id
      }).then(function () {
...
var prodId = document.querySelector('.prod-id');
var addColorBtn = document.querySelector('.add-clor-btn');
if (addColorBtn) {
  addColorBtn.addEventListener('click', function (e) {
    var id = addColorBtn.dataset.prodid;
    console.log(id);
    prodId.value = id;
  });
}
...
// delete the enquiry
var deleteEnquiry = document.querySelectorAll('.delete-enquiry');
if (deleteEnquiry) {
  deleteEnquiry.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      var id = btn.dataset.id;
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/messages/delete-message', {
        id: id
      }).then(function (res) {
        setTimeout(function () {
...
var showModalBtn = document.querySelectorAll('.view-enquiry-message');
if (showModalBtn) {
  showModalBtn.forEach(function (button) {
    button.addEventListener('click', function (e) {
      var data = JSON.parse(button.dataset.enquiry);
      var name = data.name,
        email = data.email,
        message = data.message;
      var emailPlace = document.querySelector('.enq-modal-email');
      var namePlace = document.querySelector('.enq-modal-name');
      var messagePlace = document.querySelector('.enq_modal_message');
...
var imageDeleteBtn = document.querySelectorAll('.delete-image-btn');
if (imageDeleteBtn) {
  imageDeleteBtn.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      var _btn$dataset = btn.dataset,
        id = _btn$dataset.id,
        image = _btn$dataset.image,
        color = _btn$dataset.color;
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/products/delete-product-image', {
        id: id,
        image: image,
        color: color
      }).then(function () {
...
var addImageToColorBtn = document.querySelectorAll('.add-image-to-color');
if (addImageToColorBtn) {
  addImageToColorBtn.forEach(function (btn) {
